...
function setErrorMessage(message) {
    ...
    if (errorMessage) {
        ...
        console.warn('setErrorMessage: #errorMessage element not found in DOM!');
    }
}
...
async function handleLogin(event) {
    ...
    try {
        ...
        // Fix: Support both string and object error responses
...
// Example: How to use the token for protected endpoints
// Call this after successful login or on pages that require authentication
